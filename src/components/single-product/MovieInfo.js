								...
								<div className="row">
									<div className="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-5">
										<div className="card__cover">
											<img src={`https://image.tmdb.org/t/p/w500${props.movieInfo.poster_path}`} alt="" />
										</div>
									</div>
									...
									<div className="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
										<div className="card__content">
											<div className="card__wrap">
												<span className="card__rate"><i className="icon ion-ios-star"></i>{props.movieInfo.vote_average}</span>
