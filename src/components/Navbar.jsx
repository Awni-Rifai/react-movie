                                ...
                                <div className="header__content">
                                    ...
                                    <a href="index.html" className="header__logo">
                                        ...
                                        <ul className="header__nav">
                                            ...
                                            <a className="dropdown-toggle header__nav-link"  role="button" id="dropdownMenuHome" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Home</a>
                                            ...
                                            <ul className="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuHome">
                                                ...
                                                <li><a href="index2.html">Home static bg</a></li>
                                                                        ...
                                                                        <li className="header__nav-item">
                                            <a className="dropdown-toggle header__nav-link" href="/item" role="button" id="dropdownMenuCatalog" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Catalog</a>
